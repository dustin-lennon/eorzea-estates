...
export default async function AdminDashboardPage() {
  const [userCount, estateCount] = await Promise.all([
    prisma.user.count(),
    prisma.estate.count(),
  ])
  ...
  const stats = [
    ...
    { label: "Total Estates", value: estateCount, icon: ShieldCheck, href: null },
    { label: "Moderators", value: moderatorCount, icon: ShieldCheck, href: "/admin/users" },
  ]
